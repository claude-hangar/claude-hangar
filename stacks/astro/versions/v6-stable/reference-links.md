# Astro 6 Stable — Reference Links
...
- [CSP](https://docs.astro.build/en/guides/content-security-policy/)
- [Responsive Images](https://docs.astro.build/en/guides/images/)
...
As of: 2026-04-16 (updated for Astro 6.1.7, Vite 8.0.8, Zod 4.3.6)
