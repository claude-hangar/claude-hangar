...
**Astro 6 has been stable since March 10, 2026 (latest: 6.1.4).** For migration 5->6 use the `v6-beta/` checklist (74 checks, all breaking changes). For best practices on 6.x use the `v6-stable/` checklist (31 checks).
